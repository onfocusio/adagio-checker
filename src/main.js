...
export async function main() {
    ...
    if (prebidObject === undefined) appendHomeContainer(`🔴 No Prebid wrapper detected - Try to reload checker / page.`);
    else if (apiReadyCall === null) appendHomeContainer(`🔴 Adagio API is not reachable - Contact SE.`);
