 ...
 */
export function appendAdUnitsRow(doc, prebidBidders, prebidBidRequested, prebidAdagioBidRequested, apiRecordsItems) {
    ...
    prebidBidRequested.forEach((bid) => {
        ...
        bidderParamButton.addEventListener('click', () => createBidderParamsModal(doc, bid, paramsCheckingArray, bidderAdagioDetected));
